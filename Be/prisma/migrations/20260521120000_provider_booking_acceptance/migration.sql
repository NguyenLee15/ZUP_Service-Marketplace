...
ALTER TABLE "bookings"
  ADD COLUMN IF NOT EXISTS "provider_accepted_at" TIMESTAMP(3),
  ADD COLUMN IF NOT EXISTS "provider_response_deadline" TIMESTAMP(3);
...
CREATE INDEX IF NOT EXISTS "bookings_status_provider_accepted_at_provider_response_deadline_idx"
