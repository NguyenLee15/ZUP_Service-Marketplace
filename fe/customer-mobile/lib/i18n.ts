...
const DICTIONARY: Record<string, string> = {
  ...
  'auth.biometric_prompt': 'Bạn có muốn dùng FaceID/vân tay để mở khóa phiên đăng nhập cho lần sau không?',
  ...
  'auth.biometric_error': 'Chưa thể xác thực sinh trắc học. Vui lòng đăng nhập lại.',
