...
const csp = [
  ...
  "img-src 'self' data: blob: https://res.cloudinary.com https://api.dicebear.com https://lh3.googleusercontent.com https://images.unsplash.com https://i.pravatar.cc https://*.tile.openstreetmap.org",
  "font-src 'self' data:",
