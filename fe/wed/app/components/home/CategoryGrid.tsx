  ...
  return (
    <section className="relative">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-x-5 gap-y-8 md:gap-6">
          {categories.map((cat, idx) => {
            ...
            return (
              ...
              >
                <div className="group flex flex-col items-center gap-4 cursor-pointer active-pop">
                  <div className="w-20 h-20 md:w-[5.5rem] md:h-[5.5rem] bg-white rounded-[1.25rem] flex items-center justify-center shadow-[var(--brand-shadow-sm)] border border-platinum-tint/70 group-hover:shadow-[var(--brand-shadow-card)] group-hover:-translate-y-1 transition-[box-shadow,transform,border-color] duration-300 relative overflow-hidden group-hover:border-action-blue/30">
                    <div className="absolute inset-0 bg-white/20 opacity-0 group-hover:opacity-100 transition-opacity" />
                    <IconComponent className="w-9 h-9 md:w-10 md:h-10 text-action-blue group-hover:scale-105 transition-transform duration-300" />
                  </div>
                  <div className="text-center">
                    <h3 className="font-bold text-midnight-indigo text-sm md:text-base mb-1 group-hover:text-action-blue transition-colors">{cat.label}</h3>
