              ...
              <table className="w-full text-left border-collapse text-xs">
                <thead>
                  <tr className="bg-white/5 text-muted-foreground border-b border-white/10">
                    ...
                    <th className="p-2.5 font-semibold text-center w-24">
                      Số lượng
                    </th>
                    <th className="p-2.5 font-semibold text-right w-24">
                      Tạm tính
                    </th>
                  </tr>
                </thead>
                ...
                <table className="w-full text-left border-collapse text-xs">
                  <thead>
                    <tr className="bg-white/10 text-slate-900 dark:text-white/80 border-b border-white/15">
                      <th className="p-2.5 font-semibold">
                        Chi tiết hạng mục sửa chữa thực tế
                      </th>
                      <th className="p-2.5 font-semibold text-center w-24">
                        Số lượng
                      </th>
...
function StatusBadge({ status }: { status: string }) {
  const configs: Record<string, string> = {
    PENDING:
      "bg-yellow-100/80 text-yellow-700 shadow-[0_0_8px_rgba(234,179,8,0.15)]",
    QUOTED:
      "bg-action-blue/10 text-action-blue shadow-[0_0_8px_rgba(0,107,255,0.15)]",
    CONFIRMED:
      "bg-glacier-blue/10 text-glacier-blue shadow-[0_0_8px_rgba(0,78,186,0.15)]",
    IN_PROGRESS:
      "bg-cyan-100/80 text-cyan-700 shadow-[0_0_8px_rgba(6,182,212,0.2)]",
    DONE: "bg-green-100/80 text-green-700 shadow-[0_0_8px_rgba(22,163,74,0.15)]",
    DISPUTED:
      "bg-red-100/80 text-red-700 shadow-[0_0_8px_rgba(220,38,38,0.15)]",
