                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-1">
                      <h4 className={`font-semibold text-base ${notification.isRead ? 'text-slate-300' : 'text-white'}`}>
                        {notification.title}
                      </h4>
                    ...
                    <p className={`text-sm leading-relaxed ${notification.isRead ? 'text-slate-400' : 'text-slate-200'}`}>
