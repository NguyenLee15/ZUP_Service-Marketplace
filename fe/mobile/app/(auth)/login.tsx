  ...
  return (
    ...
    >
      ...
      >
        ...
        <View style={[styles.logoWrap, { width: 64, height: 64, borderRadius: 14, overflow: "hidden", alignSelf: "center" }]}>
          <Image
            source={require("../../assets/icon.png")}
            style={{ width: 94, height: 94, position: 'absolute', top: -15, left: -15 }} // Scale up and center it using negative margins
            resizeMode="contain"
          />
        </View>
