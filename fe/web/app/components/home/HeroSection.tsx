...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden border-b border-slate-200/70 bg-slate-50/80 py-8 dark:border-slate-800/70 dark:bg-slate-950 sm:py-12 lg:py-16">
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="lg:grid lg:grid-cols-12 lg:gap-10 xl:gap-14 lg:items-center">
          {/* Left Column: Heading, Value proposition & Primary Search */}
          <div className="min-w-0 lg:col-span-7">
            ...
            <h1 className="mt-5 text-3xl font-extrabold leading-[1.15] tracking-tight text-slate-900 dark:text-slate-100 sm:text-5xl lg:text-[3.25rem] text-balance">
            ...
            <p className="mb-6 mt-4 max-w-2xl text-sm leading-relaxed text-slate-600 dark:text-slate-400 sm:text-base md:text-lg text-balance">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-1 text-xs font-medium text-slate-600 dark:text-slate-400 sm:gap-6">
          ...
          {/* Right Column: Hero Interactive Showcase (Desktop) */}
          <div className="mt-10 hidden lg:block lg:col-span-5 lg:mt-0">
            <HeroShowcaseVisual />
          </div>
        </div>
      </div>
