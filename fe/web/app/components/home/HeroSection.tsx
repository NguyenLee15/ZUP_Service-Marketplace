...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden border-b border-slate-200/70 bg-slate-50 py-8 dark:border-slate-800/70 dark:bg-slate-950 sm:py-12 lg:py-14">
      <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-8 px-4 sm:px-6 lg:grid-cols-[1fr_0.9fr] lg:gap-12 lg:px-8">
        <div className="min-w-0">
          ...
          <h1 className="mt-5 max-w-2xl text-3xl font-extrabold leading-[1.12] tracking-tight text-slate-900 dark:text-slate-100 sm:text-5xl lg:text-[3.4rem] text-balance">
          ...
          <p className="mb-6 mt-5 max-w-xl text-sm leading-relaxed text-slate-600 dark:text-slate-400 sm:text-base md:text-lg text-balance">
