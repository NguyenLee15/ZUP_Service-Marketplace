  ...
  return (
    <SocketProvider>
      <div className="min-h-[100dvh] bg-background flex flex-col">
        ...
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-50 focus:px-4 focus:py-2 focus:bg-primary focus:text-primary-foreground focus:rounded-lg focus:shadow-lg focus:outline-none font-medium text-sm"
        >
