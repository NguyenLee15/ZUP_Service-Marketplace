...
1. Plan: BẮT BUỘC cập nhật `implementation_plan.md` cho các task LỚN, phức tạp. Với các task NHỎ (sửa lỗi UI, fix bug lặt vặt), KHÔNG CẦN lập plan để tiết kiệm thời gian.
